...
public class EmployeeRegisterController {
	...
	@PostMapping
	public String comfirm(@Validated Employee employee,BindingResult result,Model model) {
		DepartmentList departmentList = departmentService.listOf();
		model.addAttribute("departmentList", departmentList);
	...
	@PostMapping("execute")
	public String register(Employee employee,SessionStatus sessionStatus) {
